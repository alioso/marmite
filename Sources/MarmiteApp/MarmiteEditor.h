...
public:
    HelpContent() {
        ...
        const juce::String bodyText =
            ...
            "PER-VOICE CONTROLS\n"
            "Enabled - mutes/unmutes the voice. Solo - the \"S\" button "
            "next to Enabled; while any voice is soloed, only soloed "
            "voices are audible (the rest keep running underneath, just "
            "silently). Volume - overall level.\n"
            ...
            "Clear reverts it back to the procedural default.\n\n"
            ...
            "between fixed presets. Like Space, Wild autonomously drifts "
            "on its own alongside Evolution Amount/Speed - it isn't just "
            "a fixed baseline you set once. The pattern itself holds "
            "steady across bars rather than re-rolling every hit - a "
            "per-voice Busy knob (see above) offsets that voice above or "
            "below this room-wide setting.\n"
